...
- [Acceptable use](INSTANCE-ACCEPTABLE-USE.md) -- good-faith use, no wallet abuse, and the CSAM / NCII bright line.
- [The privacy commitment](PRIVACY-COMMITMENT.md) -- **a pointer, not the text.** The product-wide commitment behind these notices, canonical at the constellation hub. Prism is one of the two products where "we hold nothing" is not literally true, and the commitment says so in bold.
